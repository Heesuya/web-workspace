...
public class TestController {
	...
	@GetMapping(value="/request") //Servlet 을 대체할 친구예영~
	...
	//public String request2(HttpServletRequest request) {
		//1. 인코딩 -> SpringBoot는 기본적으로 UTF-8인코딩을 수행하기때문에 작업하지 않아도 무관
	...
	public String test2(Model model) {
		...
		Student s2 = new Student("학생2", 30, "부산광역시");
	...
	public String test4(Model model) {
		...
		Student s = new Student("학생이름", 100, "학생주소");
